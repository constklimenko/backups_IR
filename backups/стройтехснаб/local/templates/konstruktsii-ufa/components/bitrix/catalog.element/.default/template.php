...
?>
<div class="bx-catalog-element block-width bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid">
		...
		if ($arParams['DISPLAY_NAME'] === 'Y')
		{
			...
			<div class="row">
				<div class="col-xs-12">
					<h1 class="bx-title  zag-container""><?=$name?>   </h1>
				</div>
			</div>
			<?
		}
	...
	<a href="/">Главная</a> - <a href="/katalog/">Каталог</a>  - <a href="<?=CMain::GetCurPage();?>"> <?=$arResult[NAME];?> </a>
		...
		<div class="row">
			<div class="col-md-6 col-sm-12">
				...
				<div class="product-item-detail-slider-container  byka" id="<?=$itemIds['BIG_SLIDER_ID']?>">
