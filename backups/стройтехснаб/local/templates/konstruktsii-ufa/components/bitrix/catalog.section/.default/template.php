...
<div id="navibar" class="block-width">
	<a href="/">Главная</a> - <a href="/katalog/">Каталог</a> - <a href="<?=CMain::GetCurPage();?>"> <?=$arResult[NAME];?> </a>
...
<div class="catalog-section1 bx-<?=$arParams['TEMPLATE_THEME']?>  " data-entity="<?=$containerName?>">
	...
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
			<div class="row <?=$rowData['CLASS']?>  block-width " data-entity="items-row">
				<?
				switch ($rowData['VARIANT'])
				{
					case 0:
						?>
						<div class="col-xs-12 product-item-small-card1  katalog-main ">
							<div class="row">
					...
					case 4:
						...
						<div class="col-sm-6 product-item-small-card1 katalog-main">
							<div class="row">
								<?
