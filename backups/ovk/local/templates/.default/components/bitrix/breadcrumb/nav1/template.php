...
for($index = 0; $index < $itemSize; $index++)
{
	...
	if($ncounter > 0){
		...
		$strReturn .=  '<div class="bx-breadcrumb-item" ><a class="no-decor" href="/"><span>Главная  </span></a><span> - </span></div>'; $ncounter--;};
	...
	if($arResult[$index]["LINK"] <> "" && $index != $itemSize-1)
	{
		$strReturn .= '
			<div class="bx-breadcrumb-item" id="bx_breadcrumb_'.$index.'" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
				'.$arrow.'
				<a class="no-decor" href="'.$arResult[$index]["LINK"].'" title="'.$title.'" itemprop="url">
