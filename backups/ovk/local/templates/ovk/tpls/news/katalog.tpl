...
<div class="katalog1"><a href="%link%"><div class="img-katalog1" style="background: url(%header_pic%) no-repeat;background-size: cover;background-position: center;"></div><span style="display:none">%header%</span><div class="opis-katalog1"><span></span>%header% %custom vivod_cena_kat(%cena_kondicionerov%)%</div></a></div> 
END;
