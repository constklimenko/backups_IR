...
"streetAddress": "ул. Заводская 11/1 "
    ...
    .no-hidden {
     ...
     @font-face {
        ...
        src: url('/local/templates/ovk/css/fonts/roboto-medium.ttf');
    }

    @font-face {
        font-family: 'Roboto Light';
        src: url('/local/templates/ovk/css/fonts/roboto-light.ttf');
    }

    @font-face {
        font-family: 'Roboto Regular';
        src: url('/local/templates/ovk/css/fonts/roboto-regular.ttf');
    }

    @font-face {
        font-family: 'Roboto Bold';
        src: url('/local/templates/ovk/css/fonts/roboto-bold.ttf');
    } 
    ...
    .logo {
        ...
        width: 204px;
        height: 46px;
        background: url(/local/templates/ovk/images/obk.png) no-repeat;
    ...
    .icon-1 {
        background: url(/local/templates/ovk/images/adress.png) no-repeat;
        background-size: contain;
    }

    .icon-2 {
        background: url(/local/templates/ovk/images/phone.png) no-repeat;
        background-size: contain;
    }

    .icon-3 {
        background: url(/local/templates/ovk/images/mail.png) no-repeat;
        background-size: contain;
    }

    .icon-4 {
        background: url(/local/templates/ovk/images/rezhim.png) no-repeat;
        background-size: contain;
    }
    ...
    .fon-main {
        background: url(/local/templates/ovk/images/fon-main.jpg) no-repeat;
    ...
    .people {
        background: url(/local/templates/ovk/images/people.png) no-repeat;
        background-size: contain;
        background-position: center;
        width: 100%;
        display: inline-block;
    ...
    .img-rab {
        background: url(/local/templates/ovk/images/rab.png) no-repeat;
        background-size: contain;
        background-position: center;
        width: 140px;
        display: inline-block;
    ...
    .polygon {
        height: 45px;
        background: url(/local/templates/ovk/images/treyg.png) no-repeat;
        background-size: contain;
        cursor: pointer;
        margin-top: -22px;
        background-position: center;
    ...
    .bg-company {
        background: url(/local/templates/ovk/images/fon-company.jpg) no-repeat;
        background-size: cover;
        background-position: center;
        width: 100%;
        display: inline-block;
    ...
    .hover-raboty1 span {
        width: 29px;
        height: 29px;
        background: url(/local/templates/ovk/images/lupa.png) no-repeat;
        background-size: contain;
        display: block;
        margin: 0 auto;
        margin-bottom: 15px;
    ...
    .swiper-container-news .swiper-button-prev {
        background-image: url(/local/templates/ovk/images/arrow-l.png) !important;
        left: 15px;
    }

    .swiper-container-news .swiper-button-next {
        background-image: url(/local/templates/ovk/images/arrow-r.png) !important;
        right: 15px;
    }
    ...
    .icon-footer1 {
        background: url(/local/templates/ovk/images/ic1.png) no-repeat;
        background-size: contain;
    }

    .icon-footer2 {
        background: url(/local/templates/ovk/images/ic2.png) no-repeat;
        background-size: contain;
    }

    .icon-footer3 {
        background: url(/local/templates/ovk/images/ic3.png) no-repeat;
        background-size: contain;
    }

    .icon-footer4 {
        background: url(/local/templates/ovk/images/ic4.png) no-repeat;
        background-size: contain;
    }
    ...
    body:after {
        content: url(/local/templates/ovk/images/close_light.png) url(/local/templates/ovk/images/loading.gif) url(/local/templates/ovk/images/prev.png) url(/local/templates/ovk/images/next.png);
        display: none
    }
    ...
    .lb-cancel {
        ...
        height: 32px;
        margin: 0 auto;
        background: url(/local/templates/ovk/images/loading.gif) no-repeat
    }
    ...
    .lb-nav a.lb-prev {
        ...
        left: 0;
        float: left;
        background: url(/local/templates/ovk/images/prev.png) left 48% no-repeat;
    ...
    .lb-nav a.lb-next {
        ...
        right: 0;
        float: right;
        background: url(/local/templates/ovk/images/next.png) right 48% no-repeat;
        filter: alpha(Opacity=0);
        opacity: 0;
        -webkit-transition: opacity .6s;
        -moz-transition: opacity .6s;
    ...
    .lb-data .lb-close {
        ...
        width: 30px;
        height: 30px;
        background: url(/local/templates/ovk/images/close_light.png) top right no-repeat;
        text-align: right;
        outline: 0;
    ...
    .certificates {
        ...
        background-image: url("/local/templates/ovk/images/certificates.jpg");
        background-repeat: no-repeat;
        background-position: center;
        background-size: cover;
    }
    ...
    .certificates__block:hover::before {
        ...
        background-image: url('/local/templates/ovk/images/search.svg');
        background-position: center;
        background-repeat: no-repeat;
	...
	false
        ...
        <div class="top-mobil">
            <div class="block-width k-menu"><a href="/" class="logo"><span style="display:none">Главная</span></a><a
                    ...
                    src="/local/templates/ovk/images/menu-button.png" id="key-request-button-1" class="burger-menu"
                    alt="Меню"></div>
        </div>
