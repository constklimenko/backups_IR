...
<div class="row-1 mb-4">
	<div class="col-2">
		...
		{
		?><ul class="inline-block katalog-main  <? echo $arCurView['LIST']; ?>"><?
			...
			switch ($arParams['VIEW_MODE'])
			{
				case 'LINE':
					foreach ($arResult['SECTIONS'] as &$arSection)
					{
						...
						if (false === $arSection['PICTURE'])
							...
							<div class="img-katalog1"  title="<? echo $arSection['PICTURE']['TITLE']; ?>" style="background: url('<? echo $arSection['PICTURE']['SRC']; ?>') no-repeat;background-size: cover;background-position: center;"></div><span style="display:none"><? echo $arSection['NAME']; ?></span><div class="opis-katalog1"><span></span><? echo $arSection['NAME']; ?></div></a></div>


							<!-- <li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="katalog1 catalog-section-list-item">
								<div class="catalog-section-list-line-img-container img-katalog1">
									<a
					...
					foreach ($arResult['SECTIONS'] as &$arSection)
					{
						...
						if (false === $arSection['PICTURE'])
							...
							<!-- <li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"  class="col-6 col-sm-3 col-md-2 catalog-section-list-item">
								<div class="catalog-section-list-tile-img-container img-katalog1">
									<a
										href="<? echo $arSection['SECTION_PAGE_URL']; ?>"
										class="catalog-section-list-item-img"
										style="background-image:url('<? echo $arSection['PICTURE']['SRC']; ?>');"
				...
				case 'LIST':
					...
					foreach ($arResult['SECTIONS'] as &$arSection)
					{
						...
						?>
						<li class="catalog-section-list-item  katalog1" id="<?=$this->GetEditAreaId($arSection['ID']);?>">
